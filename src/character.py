...
class Character:
    def __init__(self, realm, name, faction, player_spec, locale):
        self.realm = realm
        self.name = name
    ...
    def add_character_to_db(self):
        ...
        new_character = Character_DB(name = self.name, server = server_obj, faction = self.faction, player_spec = self.player_spec)
